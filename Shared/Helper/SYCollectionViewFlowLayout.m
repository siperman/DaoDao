...
@interface SYCollectionViewFlowLayout()
...
@implementation SYCollectionViewFlowLayout
...
- (void)prepareLayout {
    ...
    if([self.delegate respondsToSelector:@selector(finishFlowLayout:)]) {
        [self.delegate finishFlowLayout:[self collectionViewContentSize]];
    }
}
