...
static NSString * const kDDLongServiceTel                         = @"400-877-6737";
static NSString * const kDDServiceTel                             = @"4008776737";
...
static NSString * const kEmptyTelNotice                           = @"请填写店铺电话";
static NSString * const kEmptyAddrNotice                          = @"请填写店铺地址";
