...
@interface MJPhotoBrowser () <MJPhotoViewDelegate>
{
    ...
    // 一开始的状态栏
    UIWindowLevel _initWindowLevel;
}
@end
...
- (void)show
{
//    self.mi_statusbar = [[UIWindow alloc]initWithFrame:CGRectMake(0, 0, dotsWidth, 20)];
//    self.mi_statusbar.center = CGPointMake(160, 10);
//    [self.mi_statusbar addSubview:self.page];
//    self.mi_statusbar.backgroundColor = [UIColor colorWithWhite:0 alpha:1];
//    [self.mi_statusbar setHidden:NO];
//    self.mi_statusbar.windowLevel = UIWindowLevelStatusBar + 1.0f;
    
    UIWindow *window = [UIApplication sharedApplication].keyWindow;
    _initWindowLevel = window.windowLevel;
...
{
    UIWindow *window = [UIApplication sharedApplication].keyWindow;
    window.windowLevel = _initWindowLevel;
