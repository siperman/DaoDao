...
- (void)showAtPoint:(CGPoint)point inView:(UIView *)view withText:(NSString *)text {
    ...
    CGSize textSize = [text boundingRectWithSize:CGSizeMake([[UIScreen mainScreen] bounds].size.width - kHorizontalMargin*4.f, CGFLOAT_MAX)
...
//    CGFloat shadowBlurRadius = 10;
    ...
    NSArray* gradientColors = [NSArray arrayWithObjects:
                               (id)[UIColor colorWithR:51 g:51 b:51 a:0.8].CGColor,
                               (id)[UIColor colorWithR:51 g:51 b:51 a:0.8].CGColor, nil];
