...
- (void)initialize
{
    _placeholderColor = [UIColor colorWithR:0 g:0 b:0 a:0.22];
    _placeholderLabelRect = CGRectMake(4, 8, self.bounds.size.width - 4, 0);
    [self layoutGUI];
...
- (void)drawRect:(CGRect)rect
{
    if ([_placeholderText length] > 0)
    {
        ...
        {
            _placeholderLabel = [[UILabel alloc] initWithFrame:_placeholderLabelRect];
