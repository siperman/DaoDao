...
+ (instancetype)areaPickerWithDelegate:(id<HZAreaPickerDelegate>) delegate
{
    HZAreaPickerView *areaPicker = [[[NSBundle mainBundle] loadNibNamed:@"HZAreaPickerView" owner:self options:nil] objectAtIndex:0];
    areaPicker.pickerStyle = HZAreaPickerWithStateAndCityAndDistrict;
...
- (void)setPickerStyle:(HZAreaPickerStyle)pickerStyle
{
