...
//  LCCKChatExample
//
//  v0.7.20 Created by ElonChan (微信向我报BUG:chenyilong1010) ( https://github.com/leancloud/ChatKit-OC ) on 15/11/13.
...
- (void)configureCellWithData:(id)message {
    ...
    if ([message lcck_isCustomMessage]) {
         ...
         * fix : 邀请函头像点击
         */
        self.message = [[LCCKMessage alloc] init];
        self.message.senderId = senderClientId;
...
- (UIImageView *)avatarImageView {
    if (!_avatarImageView) {
        ...
        _avatarImageView.layer.cornerRadius = kAvatarImageViewWidth / 2;
